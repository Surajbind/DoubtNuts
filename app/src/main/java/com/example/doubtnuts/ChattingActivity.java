...
import com.example.doubtnuts.adapter.MessagesAdater;
import com.example.doubtnuts.models.Messages;
...
public class ChattingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messagesArrayList = new ArrayList<>();
        adater = new MessagesAdater(ChattingActivity.this, messagesArrayList);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                sImage = snapshot.child("profileImageUrl").getValue().toString();
                rImage = ReciverImage;
